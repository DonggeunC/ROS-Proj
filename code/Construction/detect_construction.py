...
class DetectContruction():
    def __init__(self):
        ...
        self.pub_construction_return = rospy.Publisher('/detect/construction_stamped', UInt8, queue_size=4)
        self.pub_construction_start = rospy.Publisher('/control/construction_start', UInt8, queue_size = 4)
        self.pub_moving = rospy.Publisher('/control/moving/state', MovingParam, queue_size= 4)
        self.pub_max_vel = rospy.Publisher('/control/max_vel', Float64, queue_size = 4)
        self.pub_timer_start = rospy.Publisher('/detect/timer/start', Float64, queue_size= 4)
