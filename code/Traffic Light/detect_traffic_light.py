...
class DetectTrafficLight():
    def __init__(self):
        self.hue_red_l = rospy.get_param("~detect/lane/red/hue_l", 159)
        self.hue_red_h = rospy.get_param("~detect/lane/red/hue_h", 179)
        self.saturation_red_l = rospy.get_param("~detect/lane/red/saturation_l", 48)
        self.saturation_red_h = rospy.get_param("~detect/lane/red/saturation_h", 255)
        self.lightness_red_l = rospy.get_param("~detect/lane/red/lightness_l", 86)
        self.lightness_red_h = rospy.get_param("~detect/lane/red/lightness_h", 250)

        self.hue_yellow_l = rospy.get_param("~detect/lane/yellow/hue_l", 12)
        self.hue_yellow_h = rospy.get_param("~detect/lane/yellow/hue_h", 30)
        self.saturation_yellow_l = rospy.get_param("~detect/lane/yellow/saturation_l", 207)
        self.saturation_yellow_h = rospy.get_param("~detect/lane/yellow/saturation_h", 255)
        self.lightness_yellow_l = rospy.get_param("~detect/lane/yellow/lightness_l", 145)
        self.lightness_yellow_h = rospy.get_param("~detect/lane/yellow/lightness_h", 255)

        self.hue_green_l = rospy.get_param("~detect/lane/green/hue_l", 100)
        self.hue_green_h = rospy.get_param("~detect/lane/green/hue_h", 150)
        self.saturation_green_l = rospy.get_param("~detect/lane/green/saturation_l", 108)
        self.saturation_green_h = rospy.get_param("~detect/lane/green/saturation_h", 204)
